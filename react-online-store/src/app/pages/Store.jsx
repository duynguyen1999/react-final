...
const Store = () => {
  ...
  const addToCart = async id => {
    ...
    setCart(newCart);
    localStorage.setItem(`cart_${authInfo.id}_${shopId}`, JSON.stringify(newCart));
  }
  ...
  const handleSubmitCart = async () => {
    ...
    if(deliveryInfo === "" || deliveryInfo === null || deliveryInfo === undefined){
      await placeOrder({ cartId: cartInfo.cartId, deliveryInformation: "confirm" });
    }else{
